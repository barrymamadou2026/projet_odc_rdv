      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <button onClick={() => navigate('/appointments')} className="px-6 py-3 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-semibold shadow-lg shadow-orange-500/20 transition-colors">
              Prendre rendez-vous
            </button>
            <button onClick={() => navigate('/find-doctors')} className="px-6 py-3 rounded-xl border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold transition-colors">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-white border border-gray-100 p-4 shadow-sm">
              ...
              <button onClick={() => navigate('/patient')} className="mt-2 text-xs font-semibold text-blue-600 flex items-center gap-1">
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between flex-wrap gap-4 mb-10">
            ...
            <button onClick={() => navigate('/find-doctors')} className="text-orange-600 font-semibold flex items-center gap-1">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {SERVICES.map((s, i) => (
              <div key={s.title} className="rounded-2xl border border-gray-100 p-6 hover:shadow-lg transition-shadow bg-white">
                <div className={`w-11 h-11 rounded-xl ${s.bg} ${s.color} flex items-center justify-center mb-4`}>
                  <ServiceIcon i={i} />
                </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm p-6 sm:p-10 grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <form onSubmit={search} className="mt-6 space-y-3">
                ...
                <button type="submit" className="w-full py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold transition-colors">
